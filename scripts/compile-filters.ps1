...
$Lines.Add("! Homepage: https://gitea.sickgaming.net/sickprodigy/adguard-list")
$Lines.Add("! License: https://gitea.sickgaming.net/sickprodigy/adguard-list/raw/branch/main/LICENSE")
